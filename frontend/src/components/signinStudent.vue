    ...
    <div class="login-box" style="height: auto">
      ...
      <div class="login-box-body">
        ...
        <div class="form-group has-feedback">
          <input v-on:keyup.enter="signin" v-model="name" type="text" class="form-control" placeholder="姓名（选填）">
          <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
        </div>
        <div class="form-group has-feedback">
          <input v-on:keyup.enter="signin" v-model="id" type="number" class="form-control" placeholder="准考证号（必填）">
